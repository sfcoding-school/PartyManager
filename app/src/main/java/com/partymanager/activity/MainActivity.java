                    ...
                    switch (type) {
                        ...
                        case 1:
                            ...
                            switch (method) {
                                ...
                                //'del'
                                case 3:
                                    DatiEventi.removeItem(idEvento);
                                    break;
                                //'uscito'
                                case 4:
                                    DatiEventi.getItem(idEvento).numUtenti -= 1;
                                    break;
                            }
                            break;
                            ...
                            switch (method) {
                                ...
                                case 1:
                                    ...
                                    if (template.equals("data") && idRisposta.equals("None")) {
                                        DatiEventi.getItem(idEvento).date = HelperDataParser.getCalFromString(risposta);
                                    }
                                    break;
                        ...
                        case 4:
                            ...
                            switch (method) {
                                ...
                                case 1:
                                    ...
                                    DatiEventi.getItem(idEvento).numUtenti += numAddUser;
                                    break;
                        ...
                        switch (type) {
                            ...
                            case 2:
                                if (event.getArguments().getString("param1").equals(b.getString("id_evento"))) {
                                    ...
                                    switch (method) {
                                        ...
                                        //del
                                        case 3:
                                            DatiAttributi.removeItem(idAttr);
                                    }
                                }
                            ...
                            case 3:
                                ...
                                if (Integer.parseInt(event.getArguments().getString("param1")) == b.getInt("id_evento")) {
                                    ...
                                    String risposta = b.getString("risposta");
                                    DatiAttributi.Attributo attr = DatiAttributi.getItem(idAttr);
                                ...
                                case 3:
                                    ...
                                    if (dialogIdAttributo == Integer.parseInt(b.getString("id_attributo"))) {
                                        ...
                                        switch (method) {
                                            ...
                                            //del
                                            case 3:
                                                DatiRisposte.removeItem(idRisposta);

                                                //mod
                                            case 4:
                                                int numr = Integer.parseInt(b.getString("numr"));
                                                DatiRisposte.addPersona(idRisposta, user, userName, controllo);
                                                break;
                                        }
                                        break;
                                    }
